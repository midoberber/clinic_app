...
class AppData {
  ...
  int get hashCode =>
      // token.hashCode ^
      languageCode.hashCode ^ isCompleted.hashCode ^ isWheelEnabled.hashCode;

  @override
  String toString() {
    return 'AppData{ languageCode: $languageCode, isCompleted: $isCompleted,isWheelEnabled: $isWheelEnabled }';
  }
